...
```
## Index view model dat nooit echt in gebruik geweest is
```
...
```
## Verwijderde impact en urgencies methode omdat dit niet meer uit de databank kan gehaald worden
## Nu hebben we enkel de data die we gefilterd hebben, niet alles meer.
```
